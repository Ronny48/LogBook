...
const LogIn = () => {
  ...
  return (
    <>
      <div className="overflow-hidden border-y border-yellow-500/20 bg-yellow-500/10">
        <div className="flex w-max animate-marquee">
          <p className="px-8 py-2 text-sm text-yellow-600">
            ⚡ Demo environment: The backend runs on a free hosting tier and may
            take up to ~30 seconds to wake from inactivity. If your first
            request doesn't respond, please wait a moment and try again.
          </p>
        ...
        <div className="pl-2">
          <div className=" bg-[#0f172a] p-4 rounded-2xl text-gray-200">
            ...
            <p className=" text-white ">
              Hint: Click on "Office Dashboard/Receptionist Desk" on the Navbar
              to <span className="font-bold">Logout</span>
            </p>
          </div>
        </div>
      </div>
